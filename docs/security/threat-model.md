...
- [ ] ARD artefacts regenerated (`npm run generate-ard`, automatic in postbuild) — the well-known user-site path was deliberately not adopted; discovery is via `rel="ard"` + in-page JSON-LD on the demo site
